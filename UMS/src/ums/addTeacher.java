...
{
    JFrame f;
    JLabel id, id1, id2, id3, id4, id5, id6, id7, id8, id11, id12, id15, id16, id17, lab, lab1, lab2;
    ...
    public void actionPerformed(ActionEvent ae)
    {
        ...
        if (ae.getSource() == b)
        {
            ...
            {
                conn cc = new conn();
                String q = "insert into teacher values('" + a + "','" + bb + "','" + c + "','" + d + "','" + e + "','" + ff + "','" + g + "','" + k + "','" + l + "','" + m + "')";
