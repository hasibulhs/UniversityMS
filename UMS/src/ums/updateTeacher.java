...
{
    JFrame f;
    JLabel id, id1, id2, id3, id4, id5, id6, id7, id8, id12, id15, lab1, lab2;
    JTextField t, t1, t2, t3, t4, t5, t6, t7, t11, t12, t14;
    JButton b, b1, b2;
    String id_emp;
    ...
    updateTeacher()
    {
        ...
        lab2.setBounds(400, 320, 150, 30);
        lab2.setFont(new Font("serif", Font.BOLD, 20));
        f.add(lab2);

        t14 = new JTextField();
        t14.setBounds(600, 320, 150, 30);
        f.add(t14);

        id12 = new JLabel("Education");
        id12.setBounds(50, 370, 150, 30);
        id12.setFont(new Font("serif", Font.BOLD, 20));
        f.add(id12);

        t11 = new JTextField();
        t11.setBounds(200, 370, 150, 30);
        f.add(t11);
    ...
    public void actionPerformed(ActionEvent ae)
    {
        if (ae.getSource() == b)
        {
            ...
            {
                conn con = new conn();
                String str = "update teacher set name='" + t1.getText() + "',fathers_name='" + t2.getText() + "',age='" + t3.getText() + "', dob='" + t4.getText() + "',address='" + t5.getText() + "',phone='" + t6.getText() + "',email='" + t7.getText() + "',education='" + t11.getText() + "',dept='" + t14.getText() + "' where emp_id='" + t12.getText() + "'";
        ...
        if (ae.getSource() == b2)
        {
            try
            {
                ...
                if (rs.next())
                {
                    ...
                    t11.setText(rs.getString(8));
                    t14.setText(rs.getString(10));
                }
