...
public class project extends JFrame implements ActionListener
{
    ...
    project()
    {
        ...
        ImageIcon ic = new ImageIcon(ClassLoader.getSystemResource("ums/icons/img3.jpg"));
        ...
        ImageIcon icon1 = new ImageIcon(ClassLoader.getSystemResource("ums/icons/icon1.png"));
        ...
        ImageIcon icon2 = new ImageIcon(ClassLoader.getSystemResource("ums/icons/icon2.png"));
        ...
        ImageIcon icon4 = new ImageIcon(ClassLoader.getSystemResource("ums/icons/icon3.png"));
        ...
        ImageIcon icon5 = new ImageIcon(ClassLoader.getSystemResource("ums/icons/icon4.jpg"));
        ...
        ImageIcon icon23 = new ImageIcon(ClassLoader.getSystemResource("ums/icons/icon14.jpg"));
        ...
        ImageIcon icon25 = new ImageIcon(ClassLoader.getSystemResource("ums/icons/icon15.png"));
        ...
        ImageIcon icon27 = new ImageIcon(ClassLoader.getSystemResource("ums/icons/icon15.png"));
        ...
        ImageIcon icon29 = new ImageIcon(ClassLoader.getSystemResource("ums/icons/icon14.jpg"));
        ...
        ImageIcon icon30 = new ImageIcon(ClassLoader.getSystemResource("ums/icons/icon16.png"));
        ...
        ImageIcon icon32 = new ImageIcon(ClassLoader.getSystemResource("ums/icons/icon17.png"));
        ...
        ImageIcon icon7 = new ImageIcon(ClassLoader.getSystemResource("ums/icons/icon5.png"));
        ...
        ImageIcon iconn = new ImageIcon(ClassLoader.getSystemResource("ums/icons/icon6.png"));
        ...
        ImageIcon icon14 = new ImageIcon(ClassLoader.getSystemResource("ums/icons/icon7.png"));
        ...
        ImageIcon icon16 = new ImageIcon(ClassLoader.getSystemResource("ums/icons/icon8.png"));
        ...
        ImageIcon icon18 = new ImageIcon(ClassLoader.getSystemResource("ums/icons/icon9.png"));
        ...
        ImageIcon icon20 = new ImageIcon(ClassLoader.getSystemResource("ums/icons/icon10.png"));
        ...
        ImageIcon icon10 = new ImageIcon(ClassLoader.getSystemResource("ums/icons/icon11.png"));
        ...
        ImageIcon icon21 = new ImageIcon(ClassLoader.getSystemResource("ums/icons/icon13.jpg"));
        ...
        ImageIcon icon11 = new ImageIcon(ClassLoader.getSystemResource("ums/icons/icon12.png"));
